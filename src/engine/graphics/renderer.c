...
int render_init(int width_def, int height_def, const char *title) {
	...
	glm_perspective(glm_rad(fov), width / (float)height, 0.1f, 100.f, projection3D);
	...
	voxelShader = shader_load("resources/shaders/voxel.vert", "resources/shaders/voxel.frag", NULL);
